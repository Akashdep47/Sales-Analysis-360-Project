Project Overview: The Sales Analysis 360 Project is a comprehensive sales analytics solution designed to analyze business performance across products, categories, stores, and regions. The project focuses on evaluating revenue, margins, customer behavior, store performance, and product trends to support data-driven decision-making. Data is extracted using SQL and processed using Python for data cleaning, exploratory data analysis (EDA), and visualization.
